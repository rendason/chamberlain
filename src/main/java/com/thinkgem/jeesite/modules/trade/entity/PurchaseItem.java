 ...
 * @version 2018-04-10
 */
public class PurchaseItem extends DataEntity<PurchaseItem> {
	
	private static final long serialVersionUID = 1L;
	private Purchase purchase;		// purchase_id 父类
	...
	@Length(min=1, max=64, message="purchase_id长度必须介于 1 和 64 之间")
