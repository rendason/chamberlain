...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/assets/inventory/form?id=${inventory.id}">库存<shiro:hasPermission name="assets:inventory:edit">${not empty inventory.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="assets:inventory:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="inventory" action="${ctx}/assets/inventory/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="costPrice" htmlEscape="false" class="input-xlarge required number"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
